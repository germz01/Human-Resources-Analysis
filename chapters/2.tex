...
Cluster, Cluster $1$, presenta un gruppo di impiegati con valori bassi in tutte le variabili utilizzate tranne
Last Evaluation, che registra uno scorre di circa $0.56$. Essendo il terzo cluster per densità di popolazione,
denota un risultato interessante e sicuramente da tenere d'occhio per i futuri sviluppi dell'azienda.
...
\begin{figure}[h!]
  ...
  relativo agli impiegati che sono rimasti.}
...
score in Satisfaction Level e un gruppo con alto score in entrambe le variabili. Per gli impiegati ancora all'
interno dell'azienda la situazione è decisamente più distribuita.
