...
\begin{figure}[t]
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[scale=0.45]{images/sales.pdf}
        \caption{Distribuzione relativa alla variabile \textit{Sales}}
        \label{fig:sales}
    \end{subfigure}
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[scale=0.45]{images/work_accident.pdf}
...
\begin{figure}[b]
    \centering
    \includegraphics[scale=0.45]{images/promotion_last_5_years.pdf}
    \caption{Distribuzione relativa alla variabile \textit{Promotion Last 5 Years}}
    \label{fig:promotion}
\end{figure}
Abbiamo rapportato in primis i dipendenti con il proprio salario, le percentuali che vengono indicate sul
grafico non sono in base alla totalità dei dipendenti ma riguardano solo il tipo di dipendente definito dalla
