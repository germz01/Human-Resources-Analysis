...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{images/catandord.pdf}
    \caption{Distribuzioni delle colonne Sales e Salary.}
    \label{salessalary}
\end{figure}
In Fig. \ref{salessalary}
