...
Con la stessa logica abbiamo usato $3$ bins per \textit{Satisfaction Level}, identificando ciascun intervallo con $low$, $medium$ e $high$. Infine utilizziamo $2$ bins per \textit{Average Montly Hours}, definendo i due intervalli come $standard$ e $intensive$. La scelta del numero di bins è basata sulla distribuzione osservata delle variabili.
...
\label{sec:discussion_most_interesting_rules}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{../images/rules/rules_general.pdf}
  \caption{Confidence in funzione del Lift per associazioni con MinSupp=$20\%$}
  \label{fig:rules_general}
\end{figure}
\begin{table}[H]
        \centering
        \begin{tabular}{| c | c | c | c | c |} \hline
            \textbf{Consequent} & \textbf{Antecedent} & \textbf{Supp} & \textbf{Conf} & \textbf{Lift} \\ \hline
            high\_SL  & ('very good\_LE',)  & 0.329 &  1.000 & 2.061 \\ \hline
            high\_SL  & ('very good\_LE','N\_P') & 0.321 &  1.000 & 2.061 \\ \hline
            high\_SL  & ('very good\_LE','N\_L') & 0.281 &  1.000 & 2.061 \\ \hline
            high\_SL  & ('very good\_LE','N\_WA') & 0.278 &  1.000 & 2.061 \\ \hline
            high\_SL  & ('very good\_LE','N\_L','N\_P') & 0.273 &  1.000 & 2.061 \\ \hline
            high\_SL  & ('very good\_LE','N\_WA','N\_P') & 0.272 &  1.000 & 2.061 \\ \hline
	    high\_SL  & ('very good\_LE','N\_L','N\_WA') & 0.232 &  1.000 & 2.061 \\ \hline
            high\_SL  & ('very good\_LE','N\_L','N\_WA','N\_P') & 0.226 &  1.000 & 2.061 \\ \hline
            very good\_LE  & ('high\_SL','N\_WA') & 0.278 & 0.681 & 2.070 \\ \hline
	    very good\_LE & ('high\_SL','N\_WA','N\_P') & 0.272 & 0.680 & 2.070 \\ \hline
	    very good\_LE  &('high\_SL') & 0.329 & 0.678 & 2.061  \\ \hline
	    very good\_LE & ('high\_SL','N\_P') & 0.331 & 0.677 & 2.059 \\ \hline
	    very good\_LE  & ('high\_SL','N\_L','N\_WA') & 0.232 & 0.668 & 2.030 \\ \hline
	    very good\_LE & ('high\_SL','N\_L','N\_WA','N\_P') & 0.226 & 0.667 & 2.026 \\ \hline
	    very good\_LE  & ('high\_SL','N\_L','N\_WA') & 0.281 & 0.666 & 2.025 \\ \hline
	    very good\_LE & ('high\_SL','N\_L','N\_WA','N\_P') & 0.273 & 0.665 & 2.023 \\ \hline
        \end{tabular}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{../images/rules/rules_specific.pdf}
  \caption{Confidence in funzione del Lift per associazioni con MinSupp=$5\%$, $Supp<20\%$ , $Lift>1$, $Conf>0.90$}
...
\begin{figure}[htbp]
  ...
  \caption{ Regole interessanti con parte conseguente \textit{Left:Yes}. Per ogni colonna i valori 10-0 corrispondono alla presenza o meno di un item nella parte antecedente della regola. Le ultime tre righe riportano il valore di Confidence, Support, e Support relativo ai dipendenti che lasciano l'azienda.}
...
\ref{tab:altreregole}. Si osserva che un basso grado di soddisfazione ('low\_SL') è associato all'aver lasciato l'azienda, ad avere una valutazione bassa e ore lavorate mensilmente alte. Un numero di progetti su cui un dipendente lavora pari a 2 è legato, tra gli altri item in tabella, ad aver lasciato l'azienda, come mostrato anche nelle regole con parte conseguente \textit{Left:Yes}. Infine una valutazione del dipendente insufficiente è legata a bassa soddisfazione, alto numero di ore lavorate e a mancata promozione. 
\begin{table}[H]
        \centering
        \begin{tabular}{| c | c | c | c | c |} \hline
            \textbf{Consequent} & \textbf{Antecedent} & \textbf{Supp} & \textbf{Conf} & \textbf{Lift} \\ \hline
            low\_SL  & ('4\_T','Y\_L','insufficient\_LE','intensive\_H')  & 0.054 &  0.990 & 7.245 \\ \hline
            2\_NP  & ('Y\_L', 'medium\_SL', '3\_T', 'standard\_H' ,'N\_P') & 0.100 &  0.996 & 6.256 \\ \hline
            insufficient\_LE  & ('low\_SL','intensive\_H','N\_P') & 0.281 &  1.000 & 3.861 \\ \hline
        \end{tabular}
...
Date le varie association rules trovate dalle varie prove quelle descritte nella sezione \ref{sec:discussion_most_interesting_rules} sono quelle più significative per predire se un impiegato lascerà prematuramente l'azienda oppure no. I risultati sono emersi dall'applicazione delle association rules al dataset costruito con il procedimento spiegato nella sezione introduttiva di questo capitolo.
\begin{figure}[H]
	\centering
        \includegraphics[width=0.45\textwidth]{images/rules/confusion_matrixrules_left_class_c85.pdf}
        \caption{Confusion Matrix con $confidence$ = 85}
        \label{fig:sales}
\end{figure}
Si evince che il classificatore riesce a determinare ciò che segue:
