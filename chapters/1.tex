...
\begin{figure}[b!]
  ...
  \begin{subfigure}{0.4\textwidth}
    ...
    \label{fig:promotion}
  \end{subfigure}
  \caption{Distribuzioni relative alla variabile \textit{Work Accident} (\ref{fig:work_accident}) e alla
  variabile \textit{Promotion Last 5 Years} (\ref{fig:promotion}).}
