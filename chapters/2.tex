...
<<<<<<< HEAD
  \includegraphics[width=0.8\textwidth]{../images/hierarchical/complete_dendrogram_average_euclidean.pdf}
\end{figure}
...
\todo[inline]{ TODO:- taglio del dendrogramma e silhouette, in base al numero di cluster ottenuto in k-means e dbscan\\
