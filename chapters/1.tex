...
\begin{table}[H]
    ...
    \begin{subtable}{\linewidth}
        ...
        \end{tabular}
        \caption{Livello di soddisfazione per il dipendente relativo all'ultima valutazione.}
        \label{tab:last_ev}
    \end{subtable}
\end{table}
...
A questo punto è giusto analizzare il livello di soddisfazione dei dipendenti, del quale possiamo osservare la
distribuzione in Figura \ref{fig:sat_lev} e le relative percentuali in Tabella \ref{tab:sat_lev}. \\
Possiamo rapportare rispetto alla precedente valutazione del livello di soddisfazione (cambiare valori
della tabella) osservan
