...
In questa tabella, per ogni variabile, è stato riportato il tipo di dato usato per classificarla, seguendo la
nomenclatura fornita nel testo utilizzato durante il corso, \textit{Guide to Intelligent Data Analysis}.
