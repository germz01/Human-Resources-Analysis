...
\begin{figure}
    \centering
    \subcaptionbox{\label{salary}}{\includegraphics[scale=0.5]{images/salary.pdf}}
    \subcaptionbox{\label{sales}}{\includegraphics[scale=0.5]{images/sales.pdf}}
    \subcaptionbox{\label{satisfaction_level}}{\includegraphics[scale=0.5]{images/satisfaction_level.pdf}}
    \subcaptionbox{\label{average_montly_hours}}{\includegraphics[scale=0.5]{images/average_montly_hours.pdf}}
    \subcaptionbox{\label{promotion_last_5_years}}{\includegraphics[scale=0.5]{images/promotion_last_5_years.pdf}}
    \subcaptionbox{\label{number_project}}{\includegraphics[scale=0.5]{images/number_project.pdf}}
    \caption{Da sinistra verso destra, e dall'alto verso il basso, sono raffigurate le distribuzioni delle
    colonne \textit{Salary}, \textit{Sales}, \textit{Satisfaction Level}, \textit{Average Montly Hours},
    \textit{Promotion Last 5 Years} e \textit{Number Project}. In rosso vengono rappresentati gli impiegati che
    sono rimasti nell'azienda, mentre in blu quelli che se ne sono andati.}
\end{figure}
\begin{figure}
    \centering
    \subcaptionbox{\label{time_spend_company}}{\includegraphics[scale=0.5]{images/time_spend_company.pdf}}
    \subcaptionbox{\label{work_accident}}{\includegraphics[scale=0.5]{images/work_accident.pdf}}
    \subcaptionbox{\label{last_evaluation}}{\includegraphics[scale=0.5]{images/last_evaluation.pdf}}
    \caption{Da sinistra verso destra, e dall'alto verso il basso, sono raffigurate le distribuzioni delle
    colonne \textit{Time Spend Company}, \textit{Work Accident}, \textit{Last Evaluation}.}
\end{figure}
In questo paragrafo vengono presentati i grafici relativi alla distribuzione dei valori assunti dalle colonne
descritte nella sezione precedente. Viene omesso il codice con i quali tali grafici sono stati costruiti.
Cominciando dalla Fig. \ref{salary}, utilizzando le informazioni fornite dalla statitisca descrittiva, osserviamo
che $3571$ impiegati, dei quali $2172$ rientranti nella categoria salariale \textit{low}, hanno lasciato l'azienda,
mentre $11428$, dei quali $5144$ rientranti nella categoria salariale \textit{low}, sono rimasti. La Fig.
