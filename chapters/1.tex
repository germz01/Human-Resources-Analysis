...
L'individuazione dei possibili outliers di una variabile numerica continua consiste nel verificare se siano presenti dei valori estremi rispetto alla distribuzione dei dati osservati. I test comunemente utilizzati come il test di Grubb o il criterio di Chauvenet sono basati sull'assunzione di una distribuzione di probabilità gaussiana. 
