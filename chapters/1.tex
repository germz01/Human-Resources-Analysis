...
\begin{wrapfigure}{r}{8cm}
    \begin{center}
        \subcaptionbox{\label{fig:sales}}{\includegraphics[scale=0.45]{images/sales.pdf}}
        \subcaptionbox{\label{fig:work_accident}}{\includegraphics[scale=0.45]{images/work_accident.pdf}}
        \subcaptionbox{\label{fig:promotion}}{\includegraphics[scale=0.45]{images/promotion_last_5_years.pdf}}
    \end{center}
\end{wrapfigure}
Prima di tutto vogliamo studiare la  distribuzione dei dipendenti rispetto alle variabili categoriche.
La distribuzione mostrata in Figura \ref{fig:sales} indica la distribuzione degli impiegati nei vari settori:
(parte mancante). \\
