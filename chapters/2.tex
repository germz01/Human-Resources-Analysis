...
\begin{figure*}[htbp]
  \centering
  \includegraphics[width=\linewidth]{../images/hierarchical/methods_comparison.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{../images/hierarchical/dendrogram_average_euclidean.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\linewidth]{../images/hierarchical/silhouette_average_euclidean_n2.pdf}
  \caption{Confronto tra silhouette medie, per due clusters}
\end{figure}

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\linewidth]{../images/hierarchical/silhouette_comparison.pdf}
  \caption{Confronto tra silhouette medie, per due clusters}
\end{figure}
