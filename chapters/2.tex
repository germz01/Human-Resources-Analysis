...
\ref{fig:clu_tot}. La densità di popolazione dei cluster ottenuti è osservabile in Figura \ref{fig:dist_clu}.
Il primo cluster emerso, Cluster $0$, contraddistingue gli impiegati con un alto score nella
variabile Last Evaluation
\begin{figure}[t]
  \centering
  \subcaptionbox{Rappresentazione bidimensionale, svolta sulle variabili \textit{Satisfaction Level} e
    \textit{Last Evaluation}, dell'algoritmo K-means applicato alle variabili descritte in Sezione
    \ref{sub:choice_of_attributes_and_distance_function}. Ad ogni cluster è assegnato un colore distinto, mentre
    i centroidi sono rappresentati dai simboli "\textbf{+}".\label{fig:clu_tot}}
    {\includegraphics[width=0.4\textwidth]{images/kmeans/cluster_total.pdf}}
  \subcaptionbox{Distribuzione del numero di impiegati per ognuno dei cluster scoperti durante l'analisi, in
  ordine decrescente per densità di popolazione.\label{fig:dist_clu}}{\includegraphics[width=0.4\textwidth]
  {images/kmeans/dist_cluster.pdf}}
\end{figure}
\begin{table}
  \begin{subtable}{0.5\linewidth}
    ...
    \begin{tabular}{| l | r | r | r | r | r |}
      \toprule
      {} & \multicolumn{5}{l}{Average\_Montly\_Hours} \\
  ...
  \begin{subtable}{0.5\linewidth}
    ...
    \begin{tabular}{| l | r | r | r | r | r |}
      \toprule
      {} & \multicolumn{5}{l}{Last\_Evaluation} \\
      {} & count & mean & std & min & max\\
      Cluster & & & & & \\
      \midrule
  ...
  \begin{subtable}{0.5\linewidth}
    ...
    \begin{tabular}{| l | r | r | r | r | r |}
      \toprule
      {} & \multicolumn{5}{l}{Number\_Project} \\
      {} & count & mean & std & min & max\\
      Cluster & & & & & \\
      \midrule
      0 & 1494.0 &  0.811693 &  0.138791 &  0.37 & 1.0  \\
  ...
  \begin{subtable}{0.5\linewidth}
    ...
    \begin{tabular}{| l | r | r | r | r | r |}
      \toprule
      {} & \multicolumn{5}{l}{Satisfaction\_Level} \\
      {} & count & mean & std & min & max\\
      Cluster & & & & & \\
      \midrule
  ...
  \begin{subtable}{\linewidth}
    ...
    \begin{tabular}{| l | r | r | r | r | r |}
      \toprule
      {} & \multicolumn{5}{l}{Time\_Spend\_Company} \\
      {} & count & mean & std & min & max\\
      Cluster & & & & & \\
      \midrule
