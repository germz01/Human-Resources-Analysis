...
\begin{figure}[t]
  ...
  \subcaptionbox{Rappresentazione bidimensionale, svolta sulle variabili \textit{Satisfaction Level} e
    ...
    i centroidi sono rappresentati dai simboli "\textbf{+}".\label{fig:clu_tot}}{\includegraphics[width=0.4\textwidth]{images/kmeans/cluster_total.pdf}}
  \subcaptionbox{Distribuzione del numero di impiegati per ognuno dei cluster scoperti durante l'analisi, in ordine
    decrescente per densità di popolazione.\label{fig:dist_clu}}{\includegraphics[width=0.4\textwidth]{images/kmeans/dist_cluster.pdf}}
