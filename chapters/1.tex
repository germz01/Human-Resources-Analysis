...
Da questo possiamo definire che ad avere una correlazione debole è la variabile time_spend_company con
left, last_evaluation, number_project e average_monthly_hours. Queste ultime, ad eccezione di left, invece sono correlate fra loro
in modo moderato con un valore massimo di $0.42$ tra average_monthly_hours e number_project. Il valore 
$1$ indica la correlazione con se stesso che infatti è massima. 
Dal punto di vista della correlazione negativa, abbiamo debolmente correlati left con work_accident e
satisfaction_level con number_projecy e time_spend_company. Abbiamo invece una correlazione negativa
moderata tra left e satisfaction_level di valore $-0.39$.
