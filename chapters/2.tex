...
I risultati sono mostrati in Fig \ref{fig:hierarchical-taglio} e mostrano che i due metodi anche se danno risultati simili possono presentare comunque scostamenti rilevanti, a parità di numero di cluster ottenuti con un taglio.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{../images/hierarchical/complete_dendrogram_centroid_euclidean.pdf}
  \caption{Dendrogramma con la migliore cophenetic correlation.}
\end{figure}
...
\end{figure}
  ...
  \begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{../images/hierarchical/silhouette_average_euclidean_n2.pdf}
  \caption{Confronto tra silhouette medie, per due clusters}
\end{figure}
\end{comment}
