...
\begin{table}[H]
        ...
        \begin{tabular}{| c | c | c | c |} \hline
            \textbf{Dipartimento} & \textbf{InAzienda} & \textbf{OutAzienda} &  \textbf{TotDip} \\ \hline
...
\end{minipage}
\\
Nel grafico a sinistra si studia il rapporto tra i dipendenti e la presenza o meno di un infortunio durante il periodo di lavoro all'interno dell'azienda e si è riscontrato che di quelli che l'hanno lasciata soltanto $169$ impiegati hanno avuto un incidente sul lavoro (circa il 4,75\% su $3571$ e circa il 1,13\% dei dipendenti totali), mentre gli impiegati ancora all'interno dell'azienda ad aver subito un incidente sono $2000$ (circa il 17,5\% su $11428$ e circa il 13,35\% dei dipendenti totali )
...
Nel dataset non risultano presenti nè missing values nè errori sintattici. L'individuazione dei possibili outliers delle variabili numeriche consiste nel verificare se siano presenti dei valori estremi rispetto alle relative distribuzioni. Un metodo robusto e di immediata applicazione è quello di rappresentare i dati tramite boxplot, identificando come outliers i valori che si trovano al di fuori dei whiskers, di lunghezza massima $1.5\,IQR$. Per una distribuzione gaussiana il numero di outliers attesi al di fuori dei whiskers è circa il $7\%$. In Fig. \ref{fig:boxplots} si osserva che si hanno outliers solo per la variabile \textit{Time Spend Company}, la cui distribuzione risulta però essere asimmetrica e con una coda destra ampia come mostrato anche in Fig. REF. Gli outliers individuati non sono quindi considerati anomali, ma caratteristici della distribuzione, e non vengono eliminati dal dataset nelle successive analisi. (Altri test comunemente utilizzati, come il test di Grubb o il criterio di Chauvenet, sono basati sull'assunzione di una distribuzione di probabilità gaussiana, che non si osserva per le variabili numeriche del dataset analizzato (spiegare)).
...
\todo[inline]{Tramite k-nearest-neighbours mi pare che ci siano parecchi dati ripetuti, approfondire}
