...
\begin{figure}[H]
  \centering
  \includegraphics[angle=0,origin=c,height=5cm]{obiettivi.pdf}
  \caption{RIFARE ORIZZONTALE ?}
  \label{fig:obiettivi}
\end{figure}
%%\end{comment}
...
\begin{figure}[ht]
\includegraphics[width=\linewidth]{images/newplottedvariables/sales.pdf}
...
\begin{figure}[tbp]
  \includegraphics[width=\linewidth]{images/newplottedvariables/promotion_last_5_years.pdf}
...
\begin{figure}
  \includegraphics[width=\linewidth]{images/newplottedvariables/work_accident.pdf}
...
dipendente definito dalla riga di appartenenza. \\
    \begin{figure}[tbp]
        \includegraphics[width=\linewidth]{images/newplottedvariables/salary.pdf}
        \caption{Distribuzione relativa alla variabile \textit{Salary}.}
        \label{fig:salary}
    \end{figure}

\begin{comment}
Questa tabella non serve, si vede dal grafico come per le altre variabili categoriche.
  \begin{table}[htbp]
        \centering
...
\begin{figure}[htbp]
  \includegraphics[width=\linewidth]{images/newplottedvariables/average_montly_hours.pdf}
...
\begin{figure}[htbp]
  \includegraphics[width=\linewidth]{images/newplottedvariables/satisfaction_level.pdf}
...
\begin{figure}[htbp]
  \includegraphics[width=\linewidth]{images/newplottedvariables/last_evaluation.pdf}
...
\begin{table}[htbp]
  ...
  \end{tabular}
  \caption{Livello di valutazione del dipendente.}
  \label{tab:last_ev}
\end{table}

\begin{figure}[htbp]
  \includegraphics[width=\linewidth]{images/newplottedvariables/number_project.pdf}
...
\begin{table}[ht]
  ...
  \begin{tabular}{cccc}
\toprule
    \textbf{Dipendente} & \textbf{media} & \textbf{dev. std.} & \textbf{min,max}\\
\midrule
    InAzienda & 0.71 & 0.16 & 0.36 , 1.0\\ 
    OutAzienda & 0.71 & 0.19 & 0.45 , 1.0\\ 
\bottomrule    
  \end{tabular}
  \caption{MANCA TABELLA NUMERO DI PROGETTI}
  \label{tab:progetti}
\end{table}
%\lipsum
