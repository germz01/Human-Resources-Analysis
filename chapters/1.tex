...
riguardano solo il tipo di dipendente definito dalla colonna di appartenenza. Proseguiamo poi con il rapporto
tra dipendenti ancora in azienda e non, e il numero delle ore di lavoro in media. L'informazione chiave che
...
\end{figure}
In Figura \ref{fig:dist_num_proj} troviamo le informazioni relative alla distribuzione della variabile
\textit{Number Project}. Proseguiamo poi mostrando il tempo di impiego di lavoro nell'azienda, in Figura
\ref{fig:dist}.
\begin{figure}[b!]
  \centering
  \begin{subfigure}{0.4\textwidth}
