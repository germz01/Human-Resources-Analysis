...
\begin{figure}
    ...
    vale per gli impiegati rimasti.\label{promotion_last_5_years}}
    ...
    mentre quelli che sono rimasti hanno svolto per la maggior parte $3$ progetti.\label{number_project}}
    ...
    \subcaptionbox{\label{work_accident}}{\includegraphics[scale=0.4]{images/work_accident.pdf}}
