...
variabile \textit{Department} sono state convertite in variabili numeriche, per facilitare l'applicazione
dell'algoritmo sui records, inoltre, per fornire un \textit{target} durante la costruzione dell'albero, la
variabile
...
e uno di altezza $11$ per l'Entropia. In Figura \ref{fig:cutted_tree} possiamo osservare il dettaglio riguardante
la radice dell'albero di altezza $11$ utilizzante Gini, al fine di ottenere questo albero è stato limitato il
numero di records minimo contenuto all'interno di un nodo al $20\%$ del totale a disposizone nel dataset.
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.5\textwidth]{images/classification/decision_tree_gini_0_2_cutted.pdf}
    \caption{Dettaglio iniziale dell'albero di altezza $11$ utilizzante Gini.}
...
% {} &               {} &       8999 &      6000 &      0.91 &       0.92 &    0.67 \\ \hline
    ...
    classificazione tramite indice Gini ed Entropia. Min Samle Split rappresenta la minima percentuale di record
